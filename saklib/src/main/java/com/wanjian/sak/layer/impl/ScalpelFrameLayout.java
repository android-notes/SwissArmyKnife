 ...
 * </ul>
 */
public class ScalpelFrameLayout extends Layer {
  ...
  protected void onEnableChange(boolean enable) {
    ...
    setLayerInteractionEnabled(enable);
  }
...
//      setWillNotDraw(!enabled);
  ...
  @Override
  protected void onAfterInputEvent(View rootView, InputEvent input) {
    super.onAfterInputEvent(rootView, input);
    if (!enabled||(input instanceof MotionEvent)==false) {
      return ;
    }
