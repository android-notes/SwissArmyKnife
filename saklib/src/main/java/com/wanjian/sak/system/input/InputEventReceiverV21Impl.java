...
public class InputEventReceiverV21Impl extends InputEventReceiver {
  private ViewRootImpl $$ViewRootImpl;//该类中所有字段名排序后ViewRootImpl必须位于最前面，否则dispose方法会调用出错
  private InputEventListener listener;
  private InputEventReceiver originInputEventReceiver;

  public InputEventReceiverV21Impl(InputChannel inputChannel, Looper looper, ViewRootImpl viewRoot, InputEventListener listener, InputEventReceiver originInputEventReceiver) {
