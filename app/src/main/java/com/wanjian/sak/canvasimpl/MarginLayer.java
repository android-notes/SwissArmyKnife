    ...
    protected void drawLayer(Canvas canvas, Paint paint, View view) {
        ...
        if (params instanceof ViewGroup.MarginLayoutParams) {//画 外边距
            ...
            if (marginLayoutParams.leftMargin != 0) {
                String txt = "ML" + px2dp(marginLayoutParams.leftMargin);
            ...
            if (marginLayoutParams.topMargin != 0) {
                String txt = "MT" + px2dp(marginLayoutParams.topMargin);
                paint.getTextBounds(txt, 0, txt.length(), rect);
                paint.setColor(0x88ffffff);
                paint.setStyle(Paint.Style.FILL);
            ...
            if (marginLayoutParams.rightMargin != 0) {
                String txt = "MR" + px2dp(marginLayoutParams.rightMargin);
                paint.getTextBounds(txt, 0, txt.length(), rect);
                paint.setColor(0x88ffffff);
                paint.setStyle(Paint.Style.FILL);
            ...
            if (marginLayoutParams.bottomMargin != 0) {
                String txt = "MB" + px2dp(marginLayoutParams.bottomMargin);
                paint.getTextBounds(txt, 0, txt.length(), rect);
                paint.setColor(0x88ffffff);
                paint.setStyle(Paint.Style.FILL);
